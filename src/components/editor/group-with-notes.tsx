...
function FolderTile({ folder }: { folder: FolderWithNotes }) {
  ...
  return (
    <Link
      to={`/folder/${folder.id}`}
      className="group flex flex-col rounded-[12px] border border-line bg-surface p-2 outline-none transition-[box-shadow,border-color] duration-150 hover:border-line-2 hover:shadow-card focus-visible:ring-2 focus-visible:ring-brand"
    >
